...
#define RX_BUF_LEN 20 //maybe change to 24??????
static uint8 rx_buffer[RX_BUF_LEN];

/* Buffer to store received response message.
* Its size is adjusted to longest frame that this example code is supposed to handle. 
#define RX_poll_BUF_LEN 24
static uint8 rx_poll_buffer[RX_BUF_LEN];
*/
...
static volatile bool turn = 0;
static volatile bool send_poll = true;
