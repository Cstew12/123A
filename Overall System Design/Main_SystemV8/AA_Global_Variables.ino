...
#define TONE_LENGTH 40

long interval_beep = 1000;      //Initilizes beep interval
long previousMillis_beep = 0;  //Initilizes previous time stamp
bool State_beep = true;      //Initilizes first LED State
